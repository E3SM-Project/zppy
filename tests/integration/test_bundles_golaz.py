...
class TestBundles(unittest.TestCase):
    def test_bundles_bash_file_list(self):
        ...
        directory = "/lcrc/group/e3sm/ac.golaz/zppy_test_bundles_output/v2.LR.historical_0201/post/scripts"
    ...
    def test_bundles_bash_file_content(self):
        actual_directory = "/lcrc/group/e3sm/ac.golaz/zppy_test_bundles_output/v2.LR.historical_0201/post/scripts"
    ...
    def test_bundles_images(self):
        ...
        actual_images_dir = "/lcrc/group/e3sm/public_html/diagnostic_output/ac.golaz/zppy_test_bundles_www/v2.LR.historical_0201"
