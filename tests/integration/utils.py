...
def get_chyrsalis_expansions(config):
    ...
    d = {
        ...
        "diags_environment_commands": "source /home/ac.forsyth2/miniconda3/etc/profile.d/conda.sh; conda activate e3sm_diags_20230829",
        "diags_walltime": "5:00:00",
        "environment_commands_test": "source /lcrc/soft/climate/e3sm-unified/test_e3sm_unified_1.9.0rc14_chrysalis.sh",
...
def get_perlmutter_expansions(config):
    ...
    d = {
        ...
        "constraint": "cpu",
        # To run this test, replace conda environment with your e3sm_diags dev environment
        "diags_environment_commands": "source /global/homes/f/forsyth/miniconda3/etc/profile.d/conda.sh; conda activate e3sm_diags_20230908",
