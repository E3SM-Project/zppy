...
#SBATCH  --job-name=mpas_analysis_ts_0001-0100_climo_0051-0100
#SBATCH  --nodes=1
#SBATCH  --output=test_output/post/scripts/mpas_analysis_ts_0001-0100_climo_0051-0100.o%j
#SBATCH  --exclusive
...
# Update status file
STARTTIME=$(date +%s)
echo "RUNNING ${id}" > test_output/post/scripts/mpas_analysis_ts_0001-0100_climo_0051-0100.status
...
if [ $? != 0 ]; then
  echo 'ERROR (1)' > test_output/post/scripts/mpas_analysis_ts_0001-0100_climo_0051-0100.status
  exit 1
fi
...
if [ "${size}" = "" ] || [ "${size}" = "0" ] || [ "${error}" != "0" ];then
  echo 'ERROR (2)' > test_output/post/scripts/mpas_analysis_ts_0001-0100_climo_0051-0100.status
  exit 1
fi
...
mkdir -p ${f}
if [ $? != 0 ]; then
  echo 'ERROR (3)' > test_output/post/scripts/mpas_analysis_ts_0001-0100_climo_0051-0100.status
  exit 1
fi
...
if [ $? != 0 ]; then
  echo 'ERROR (4)' > test_output/post/scripts/mpas_analysis_ts_0001-0100_climo_0051-0100.status
  exit 1
fi
...
echo ==============================================
echo 'OK' > test_output/post/scripts/mpas_analysis_ts_0001-0100_climo_0051-0100.status
exit 0
