...
#SBATCH  --job-name=e3sm_diags_atm_monthly_180x360_aave_model_vs_obs_0021-0040
#SBATCH  --nodes=1
#SBATCH  --output=test_output/post/scripts/e3sm_diags_atm_monthly_180x360_aave_model_vs_obs_0021-0040.o%j
#SBATCH  --exclusive
...
# Update status file
STARTTIME=$(date +%s)
echo "RUNNING ${id}" > e3sm_diags_atm_monthly_180x360_aave_model_vs_obs_0021-0040.status
...
do
  ...
  if [ $? != 0 ]; then
      cd ../..
      echo 'ERROR (4)' > e3sm_diags_atm_monthly_180x360_aave_model_vs_obs_0021-0040.status
      exit 1
  fi
done
cd ..
...
if [ $? != 0 ]; then
  cd ..
  echo 'ERROR (1)' > e3sm_diags_atm_monthly_180x360_aave_model_vs_obs_0021-0040.status
  exit 1
fi
...
if [ $? != 0 ]; then
  cd ..
  echo 'ERROR (2)' > e3sm_diags_atm_monthly_180x360_aave_model_vs_obs_0021-0040.status
  exit 1
fi
...
if [ $? != 0 ]; then
  cd ..
  echo 'ERROR (3)' > e3sm_diags_atm_monthly_180x360_aave_model_vs_obs_0021-0040.status
  exit 1
fi
...
echo ==============================================
echo 'OK' > e3sm_diags_atm_monthly_180x360_aave_model_vs_obs_0021-0040.status
exit 0
