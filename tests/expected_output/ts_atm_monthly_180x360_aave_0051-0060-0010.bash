...
#SBATCH  --job-name=ts_atm_monthly_180x360_aave_0051-0060-0010
#SBATCH  --nodes=1
#SBATCH  --output=test_output/post/scripts/ts_atm_monthly_180x360_aave_0051-0060-0010.o%j
#SBATCH  --exclusive
...
# Update status file
STARTTIME=$(date +%s)
echo "RUNNING ${id}" > ts_atm_monthly_180x360_aave_0051-0060-0010.status
...
if [ $? != 0 ]; then
  cd ..
  echo 'ERROR (1)' > ts_atm_monthly_180x360_aave_0051-0060-0010.status
  exit 1
fi
...
if [ $? != 0 ]; then
  cd ..
  echo 'ERROR (2)' > ts_atm_monthly_180x360_aave_0051-0060-0010.status
  exit 2
fi
...
echo ==============================================
echo 'OK' > ts_atm_monthly_180x360_aave_0051-0060-0010.status
exit 0
